...
export type GetLaunchesQuery = { __typename?: "Query" } & {
  launches?: Maybe<
    Array<
      Maybe<
        { __typename?: "Launch" } & Pick<Launch, "mission_id" | "mission_name">
      >
    >
  >;
};
...
export type GetLaunchesWithArgsQuery = { __typename?: "Query" } & {
  launches?: Maybe<
    Array<
      Maybe<
        { __typename?: "Launch" } & Pick<Launch, "mission_id" | "mission_name">
...
export const GetLaunchesWithArgs = (
  variables: GetLaunchesWithArgsQueryVariables
) =>
  query<GetLaunchesWithArgsQuery, any, GetLaunchesWithArgsQueryVariables>(
    client,
    {
